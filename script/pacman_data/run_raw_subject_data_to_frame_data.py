...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input-dir", type=Path, default=PROJECT_ROOT / "data/pacman_data/raw_subject_data")
    parser.add_argument("--output-dir", type=Path, default=PROJECT_ROOT / "data/pacman_data/frame_data")
    parser.add_argument("--csv-output-dir", type=Path, default=PROJECT_ROOT / "data/pacman_data/frame_data_csv")
